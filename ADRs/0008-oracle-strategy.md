...
- **Native oracles** under `oracles/`, built by `nimble buildOracles`:
  - `mpfr_oracle.c` — MPFR reference for `BigFloat` transcendentals.
  - `gmp_oracle.c` — GMP reference for `BigInt` / `Rational`.
  - `eft_oracle.py` — decimal EFT reference.
